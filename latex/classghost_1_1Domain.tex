...
\begin{DoxyItemize}
\item during a move (\hyperlink{classghost_1_1Solver_af1176494b45226e87edefa0b39babf62}{Solver\-::move}), ie, when the solver assigns a new value to a given variable.
\item during a reset (\hyperlink{classghost_1_1Solver_a43db35b71a3e494ce208622cc45cbeb0}{Solver\-::reset}).
\item just between the end of the optimization run and the beginning of the optimization post-\/processing, in \hyperlink{classghost_1_1Solver_a30dd2769fb30ac42d231d2c305dcdf13}{Solver\-::solve}.
\end{DoxyItemize}
...
\hypertarget{classghost_1_1Domain_abeb28b48f75473162d0aecab6da070d3}{\index{ghost\-::\-Domain@{ghost\-::\-Domain}!possible\-Values@{possible\-Values}}
\index{possible\-Values@{possible\-Values}!ghost::Domain@{ghost\-::\-Domain}}
\subsubsection[{possible\-Values}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Type\-Variable$>$ vector$<$int$>$ {\bf ghost\-::\-Domain}$<$ Type\-Variable $>$\-::possible\-Values (
\begin{DoxyParamCaption}
\item[{const Type\-Variable \&}]{variable}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classghost_1_1Domain_abeb28b48f75473162d0aecab6da070d3}
