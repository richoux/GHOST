...
cmake -G "Visual Studio 16 2019" -A Win32 -B "build32" -D CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreadedDLL
cmake --build build32 --config Release
cmake --install build32 --prefix %InstallPath%
cmake -G "Visual Studio 16 2019" -A x64 -B "build64" -D CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded
