...
namespace ghost
{
  ...
  /*!
   * This class uses the C++11 Mersenne Twister (mt19937) as a
  ...
  public:
    ...
    /*!
     * getRandNum returns a pseudo-random value from the range [0, limit[, according a near-uniform 
     * distribution like discussed above.
     *
