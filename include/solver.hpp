...
namespace ghost
{
	...
	* you must instantiate a solver by specifying the class of your
	...
	*/
	...
	public:
		...
		* instantiate with a null Objective (pure satisfaction run) or an
		...
		double solve(double sat_timeout, double opt_timeout = 0)
		{
			...
			do // optimization loop
			{
				...
				do // solving loop 
				{
					...
					for (size_t i = 0; i < variableCost.size(); ++i)
					{
					...
					for (size_t i = 1; i < vecConstraints.size(); ++i)
