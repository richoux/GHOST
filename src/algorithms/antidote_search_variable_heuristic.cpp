...
namespace ghost
{
	int AntidoteSearchVariableHeuristic::select_variable_candidates( const SearchUnitData& data ) const
	{
		...
		return rng.variate<int, std::discrete_distribution>( error_variables.begin(), error_variables.end() );
	}
}
