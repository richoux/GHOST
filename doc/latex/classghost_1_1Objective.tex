...
\subsubsection[{\texorpdfstring{cost(vector$<$ Variable $>$ $\ast$variables) const }{cost(vector< Variable > *variables) const }}]{\setlength{\rightskip}{0pt plus 5cm}double ghost\+::\+Objective\+::cost (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classghost_1_1Objective_adf174d82bf2a9f9b0ad72f11a279799e}{}\label{classghost_1_1Objective_adf174d82bf2a9f9b0ad72f11a279799e}


Inline function following the N\+VI idiom. Calling v\+\_\+cost. 

\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a5f6db473f497e84cf15d0a638be21d31}{required\+\_\+cost} 
\end{DoxySeeAlso}
...
\subsubsection[{\texorpdfstring{expert\+\_\+heuristic\+\_\+value(vector$<$ Variable $>$ $\ast$variables, Variable $\ast$var, const vector$<$ int $>$ \&possible\+\_\+values) const }{expert_heuristic_value(vector< Variable > *variables, Variable *var, const vector< int > &possible_values) const }}]{\setlength{\rightskip}{0pt plus 5cm}virtual int ghost\+::\+Objective\+::expert\+\_\+heuristic\+\_\+value (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{{\bf Variable} $\ast$}]{var, }
\item[{const vector$<$ int $>$ \&}]{possible\+\_\+values}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\hypertarget{classghost_1_1Objective_a4e0f733d219978343b9532d1e8168510}{}\label{classghost_1_1Objective_a4e0f733d219978343b9532d1e8168510}
...
\begin{DoxyParams}{Parameters}
{\em variables} & A pointer to the vector containing all variables. \\
\hline
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a0da0d81b3f4c83cb6f4b2a33e2822d2f}{heuristic\+\_\+value}, \hyperlink{classghost_1_1Random}{Random} 
\end{DoxySeeAlso}
\index{ghost\+::\+Objective@{ghost\+::\+Objective}!expert\+\_\+heuristic\+\_\+value@{expert\+\_\+heuristic\+\_\+value}}
\index{expert\+\_\+heuristic\+\_\+value@{expert\+\_\+heuristic\+\_\+value}!ghost\+::\+Objective@{ghost\+::\+Objective}}
\subsubsection[{\texorpdfstring{expert\+\_\+heuristic\+\_\+value(vector$<$ Variable $\ast$ $>$ bad\+\_\+variables) const }{expert_heuristic_value(vector< Variable * > bad_variables) const }}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf Variable}$\ast$ ghost\+::\+Objective\+::expert\+\_\+heuristic\+\_\+value (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $\ast$ $>$}]{bad\+\_\+variables}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\hypertarget{classghost_1_1Objective_a26e649c3e9a6e71fbdac3194120728bb}{}\label{classghost_1_1Objective_a26e649c3e9a6e71fbdac3194120728bb}
...
\begin{DoxyParams}{Parameters}
{\em bad\+\_\+variables} & The vector of candidate variables the solver may swap the value with another variable it had chosen. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\subsubsection[{\texorpdfstring{expert\+\_\+postprocess\+\_\+optimization(vector$<$ Variable $>$ $\ast$variables, double \&best\+Cost, vector$<$ int $>$ \&solution) const }{expert_postprocess_optimization(vector< Variable > *variables, double &bestCost, vector< int > &solution) const }}]{\setlength{\rightskip}{0pt plus 5cm}virtual void ghost\+::\+Objective\+::expert\+\_\+postprocess\+\_\+optimization (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{double \&}]{best\+Cost, }
\item[{vector$<$ int $>$ \&}]{solution}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\hypertarget{classghost_1_1Objective_a5fb30d2973d51e6c788533f7a4b1c493}{}\label{classghost_1_1Objective_a5fb30d2973d51e6c788533f7a4b1c493}
...
The computation spantime of this function is not taken into account by timeouts given to the solver. If you override this function, be sure its computation time is neglictable compare to the optimization timeout you give to \hyperlink{classghost_1_1Solver_ab2f3b79560cefbe8299583a40edad40e}{Solver\+::solve}.
\end{DoxyWarning}

\begin{DoxyParams}{Parameters}
{\em variables} & A pointer to the vector of variables of the C\+S\+P/\+C\+OP. \\
\hline
{\em best\+Cost} & A reference the double representing the best optimization cost found by the solver so far. Its value may be updated, justifying a non const reference. \\
\hline
...
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a93e4461791d365f18078d3fc7d23a67d}{postprocess\+\_\+optimization} 
\end{DoxySeeAlso}
...
\subsubsection[{\texorpdfstring{expert\+\_\+postprocess\+\_\+satisfaction(vector$<$ Variable $>$ $\ast$variables, double \&best\+Cost, vector$<$ int $>$ \&solution) const }{expert_postprocess_satisfaction(vector< Variable > *variables, double &bestCost, vector< int > &solution) const }}]{\setlength{\rightskip}{0pt plus 5cm}virtual void ghost\+::\+Objective\+::expert\+\_\+postprocess\+\_\+satisfaction (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{double \&}]{best\+Cost, }
\item[{vector$<$ int $>$ \&}]{solution}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}\hypertarget{classghost_1_1Objective_a0d84f1a341b9366a66b3cb52568ded33}{}\label{classghost_1_1Objective_a0d84f1a341b9366a66b3cb52568ded33}
...
{\em variables} & A pointer to the vector of variables of the C\+S\+P/\+C\+OP. \\
\hline
{\em best\+Cost} & A reference the double representing the best satisfaction cost found by the solver so far. Its value may be updated, justifying a non const reference. \\
\hline
{\em solution} & A reference to the vector of variables of the solution found by the solver. This vector may be updated, justifying a non const reference \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_af7ae98042b3ba81a9bd501d542820b66}{postprocess\+\_\+satisfaction} 
\end{DoxySeeAlso}
...
\subsubsection[{\texorpdfstring{heuristic\+\_\+value(vector$<$ Variable $>$ $\ast$variables, Variable $\ast$var, const vector$<$ int $>$ \&possible\+\_\+values) const }{heuristic_value(vector< Variable > *variables, Variable *var, const vector< int > &possible_values) const }}]{\setlength{\rightskip}{0pt plus 5cm}int ghost\+::\+Objective\+::heuristic\+\_\+value (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{{\bf Variable} $\ast$}]{var, }
\item[{const vector$<$ int $>$ \&}]{possible\+\_\+values}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classghost_1_1Objective_a0da0d81b3f4c83cb6f4b2a33e2822d2f}{}\label{classghost_1_1Objective_a0da0d81b3f4c83cb6f4b2a33e2822d2f}


Inline function following the N\+VI idiom. Calling expert\+\_\+heuristic\+\_\+value. 

\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a4e0f733d219978343b9532d1e8168510}{expert\+\_\+heuristic\+\_\+value} 
\end{DoxySeeAlso}
\index{ghost\+::\+Objective@{ghost\+::\+Objective}!heuristic\+\_\+value@{heuristic\+\_\+value}}
\index{heuristic\+\_\+value@{heuristic\+\_\+value}!ghost\+::\+Objective@{ghost\+::\+Objective}}
\subsubsection[{\texorpdfstring{heuristic\+\_\+value(vector$<$ Variable $\ast$ $>$ bad\+\_\+variables) const }{heuristic_value(vector< Variable * > bad_variables) const }}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Variable}$\ast$ ghost\+::\+Objective\+::heuristic\+\_\+value (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $\ast$ $>$}]{bad\+\_\+variables}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classghost_1_1Objective_af21823582664ad75307439adf3cb1f5e}{}\label{classghost_1_1Objective_af21823582664ad75307439adf3cb1f5e}
...
\subsubsection[{\texorpdfstring{postprocess\+\_\+optimization(vector$<$ Variable $>$ $\ast$variables, double \&best\+Cost, vector$<$ int $>$ \&solution) const }{postprocess_optimization(vector< Variable > *variables, double &bestCost, vector< int > &solution) const }}]{\setlength{\rightskip}{0pt plus 5cm}void ghost\+::\+Objective\+::postprocess\+\_\+optimization (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{double \&}]{best\+Cost, }
\item[{vector$<$ int $>$ \&}]{solution}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classghost_1_1Objective_a93e4461791d365f18078d3fc7d23a67d}{}\label{classghost_1_1Objective_a93e4461791d365f18078d3fc7d23a67d}


Inline function following the N\+VI idiom. Calling expert\+\_\+postprocess\+\_\+optimization. 

\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a5fb30d2973d51e6c788533f7a4b1c493}{expert\+\_\+postprocess\+\_\+optimization} 
\end{DoxySeeAlso}
...
\subsubsection[{\texorpdfstring{postprocess\+\_\+satisfaction(vector$<$ Variable $>$ $\ast$variables, double \&best\+Cost, vector$<$ int $>$ \&solution) const }{postprocess_satisfaction(vector< Variable > *variables, double &bestCost, vector< int > &solution) const }}]{\setlength{\rightskip}{0pt plus 5cm}void ghost\+::\+Objective\+::postprocess\+\_\+satisfaction (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables, }
\item[{double \&}]{best\+Cost, }
\item[{vector$<$ int $>$ \&}]{solution}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classghost_1_1Objective_af7ae98042b3ba81a9bd501d542820b66}{}\label{classghost_1_1Objective_af7ae98042b3ba81a9bd501d542820b66}


Inline function following the N\+VI idiom. Calling expert\+\_\+postprocess\+\_\+satisfaction. 

\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_a0d84f1a341b9366a66b3cb52568ded33}{expert\+\_\+postprocess\+\_\+satisfaction} 
\end{DoxySeeAlso}
...
\subsubsection[{\texorpdfstring{required\+\_\+cost(vector$<$ Variable $>$ $\ast$variables) const =0}{required_cost(vector< Variable > *variables) const =0}}]{\setlength{\rightskip}{0pt plus 5cm}virtual double ghost\+::\+Objective\+::required\+\_\+cost (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Variable} $>$ $\ast$}]{variables}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [pure virtual]}}\hypertarget{classghost_1_1Objective_a5f6db473f497e84cf15d0a638be21d31}{}\label{classghost_1_1Objective_a5f6db473f497e84cf15d0a638be21d31}
...
\begin{DoxyParams}{Parameters}
{\em variables} & A pointer to the vector of variable of the C\+S\+P/\+C\+OP. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
\hyperlink{classghost_1_1Objective_adf174d82bf2a9f9b0ad72f11a279799e}{cost} 
\end{DoxySeeAlso}
